      ...
      <main className="px-0 pt-[40px] pb-[80px]">
        <div className="mx-auto box-border w-full max-w-[1440px] px-[48px] max-[1200px]:px-[56px] max-[768px]:px-[24px]">
          ...
          <section className="mb-[87px]">
            ...
            <div
              className="grid w-[1193px] grid-cols-[repeat(3,385px)] gap-x-[19px] gap-y-[20px] px-12 max-[1320px]:w-[789px] max-[1320px]:grid-cols-[repeat(2,385px)] max-[860px]:w-[385px] max-[860px]:grid-cols-1 max-[420px]:w-full"
