...
const PROJECTS: ProjectCard[] = [
...

  {
    ...
    description:
      "교내의 사이드 프로젝트 추적이 가능한 저장소 서비스입니다. 현재 교내 부재인 저장소 서비스를 구축함에 따라 멋사 일원 뿐만 아니라 전교 학생들의 사이드 프로젝트 참여율과 동기부여를 높이고, 학교의 개발 문화도 외부로 알릴 수 있는 메리트가 있습니다.",
    layout: "split",
  },
  {
    id: "11-apply",
  ...
  },
  {
    ...
    description:
      "Node는 치매 예방 및 증세 완화 서비스로, 4D블럭이라는 별도의 매개체와 AI의 이미지 학\n" +
  ...
  },
  {
    ...
    description:
      "프롬프렌은 AI 사용이 어려운 사람들도 효과적으로 사용할 수 있도록 돕는 프롬포트 공유 서\n" +
  ...
  },
  {
    ...
    description:
      "FRESH-TIME은 사용자의 행동 패턴을 분석하고 알림을 통해, 바른 자세의 유지를 통해 신\n" +
  ...
  },
  {
    ...
    subtitle: "도파밍 해결 서비스",
    description:
      "TIME2DO는 2024년의 신규 키워드 도파밍(Dopamine + Farming)을 해결하기 위한 서\n" +
  ...
  },
  {
    ...
    description:
      "NEWSPECT는 필터버블과 확증편향에 치우져진 현대 사회의 정신 건강을 해결하기 위한\n" +
  ...
  },
  {
    ...
    description:
      "market Bee는 AI 기술을 통하여 소상공인의 어려움을 돕고 매출 증대를 기여하는 AI\n" +
  ...
  },
  {
    ...
    description:
      "은둔 번아웃 청년을 위한 맞춤형 성장 플랫폼 리라이즈는 설문 기반 10초 감정 기록과\n" +
  ...
  },
  {
    ...
    description:
      "LOCOCO는 지역 축제의 기획자와 방문자 간 정보 비대칭을 해소하고, 침체된 지역 행사의\n" +
