...
const MainPageTextComponent = ({
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="sm:text-gray4 flex w-69 items-center justify-center text-center text-[12px] leading-4 font-medium break-all whitespace-pre-line text-white sm:w-140 sm:text-xl sm:leading-10 sm:font-medium lg:w-225 lg:text-2xl">
        {subText}
      </div>
    </div>
  );
