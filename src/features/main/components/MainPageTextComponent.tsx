...
const MainPageTextComponent = ({
  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      <div className="sm:text-gray4 flex w-78 items-center justify-center text-center text-[10px] leading-4 font-medium break-all text-white sm:w-140 sm:text-xl sm:leading-10 sm:font-medium lg:w-225 lg:text-2xl">
        {subText}
      </div>
    </div>
  );
